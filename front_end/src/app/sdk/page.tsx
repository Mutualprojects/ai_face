        ...
        return (
          <div key={ep.id} style={{ borderTop: i === 0 ? "none" : "1px solid #f1f5f9" }}>
            ...
            >
              ...
              <code style={{ fontFamily: "monospace", fontSize: 12.5, fontWeight: 700, color: "var(--text-primary)", flex: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                {ep.path}
            ...
            {expanded && (
              <div style={{ padding: "0 16px 16px 16px" }}>
                <div style={{ borderRadius: 12, background: "var(--bg-sidebar)", overflow: "hidden" }}>
                ...
                {ep.sample && (
                  <div style={{ marginTop: 10, borderRadius: 12, background: "var(--bg-input)", border: "1px solid var(--border-strong)", overflow: "hidden" }}>
                    <div style={{ padding: "8px 12px", borderBottom: "1px solid var(--border-strong)", fontSize: 10.5, fontWeight: 800, color: "#64748b", display: "flex", alignItems: "center", gap: 6 }}>
                      <Code2 size={12} /> SAMPLE RESPONSE
                    </div>
                    <pre style={{ margin: 0, padding: 12, fontSize: 11.5, color: "var(--text-secondary)", overflowX: "auto", fontFamily: "monospace", lineHeight: 1.5, whiteSpace: "pre-wrap", wordBreak: "break-all" }}>
                      {ep.sample}
                    </pre>
                  </div>
                )}
    ...
    <div style={{ minHeight: "100vh", background: "#f6f7fb", padding: "24px 36px 48px 36px" }}>
      <div style={{ width: "100%", maxWidth: 1440, margin: "0 auto" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <Link
              href="/dashboard"
              style={{
                width: 40, height: 40, borderRadius: 12, background: "var(--bg-input)", border: "1px solid var(--border-strong)",
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <h1 style={{ margin: 0, fontSize: 19, fontWeight: 900, color: "var(--text-primary)", letterSpacing: "-0.02em" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, background: "var(--bg-input)", border: "1px solid var(--border-strong)", borderRadius: 10, padding: "6px 12px", fontSize: 11.5, fontFamily: "monospace", fontWeight: 700, color: "var(--text-secondary)" }}>
              <Globe size={13} color="#0ea5e9" />
              <span>{(base.frontend || "detecting…")}</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 6, background: "var(--bg-input)", border: "1px solid var(--border-strong)", borderRadius: 10, padding: "6px 12px", fontSize: 12, fontFamily: "monospace", fontWeight: 700, color: "var(--text-secondary)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 24 }}>
          <div style={{ padding: 20, borderRadius: 18, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 10px rgba(0,0,0,0.02)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div>
              ...
              <h3 style={{ margin: "4px 0 0 0", fontSize: 26, fontWeight: 900, color: "var(--text-primary)" }}>
        ...
        {/* Tab Navigation Bar */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, background: "var(--bg-card)", border: "1px solid var(--border-strong)", borderRadius: 16, padding: "8px 12px", boxShadow: "0 2px 6px rgba(0,0,0,0.02)", marginBottom: 24, flexWrap: "wrap" }}>
          ...
          {activeTab === "presence" && (
            <div style={{ display: "flex", alignItems: "center", gap: 10, background: "var(--bg-input)", padding: "4px 10px", borderRadius: 10, border: "1px solid var(--border-strong)" }}>
              ...
              <input
                ...
                style={{ border: "none", background: "transparent", outline: "none", fontSize: 12, width: 180, fontWeight: 600, color: "var(--text-primary)" }}
              />
            </div>
          )}
        </div>
        ...
        {activeTab === "overview" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ padding: 24, borderRadius: 16, background: "linear-gradient(135deg, var(--bg-sidebar) 0%, var(--bg-card) 100%)", color: "#ffffff" }}>
            ...
            {/* Base URLs */}
            <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
              <h4 style={{ margin: "0 0 14px 0", fontSize: 14, fontWeight: 800, color: "var(--text-primary)", display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
                  ...
                  <code style={{ flex: 1, minWidth: 260, padding: "9px 12px", borderRadius: 10, background: "var(--bg-input)", border: "1px solid var(--border-strong)", fontSize: 12.5, fontFamily: "monospace", fontWeight: 700, color: "var(--text-primary)" }}>
                  ...
                  <button onClick={() => quickCopy(base.frontend)} style={{ display: "flex", alignItems: "center", gap: 5, background: "var(--bg-input)", border: "1px solid var(--border-strong)", borderRadius: 8, padding: "7px 12px", fontSize: 11.5, fontWeight: 700, color: "var(--text-secondary)", cursor: "pointer" }}>
                  ...
                  {editingBackend ? (
                    <div style={{ flex: 1, minWidth: 260, display: "flex", gap: 8 }}>
                      <input
                        ...
                        style={{ flex: 1, padding: "9px 12px", borderRadius: 10, border: "1px solid #6366f1", fontSize: 12.5, fontFamily: "monospace", fontWeight: 700, color: "var(--text-primary)", outline: "none", background: "var(--bg-input)" }}
                      />
                      ...
                      <button onClick={() => setEditingBackend(false)} style={{ background: "var(--bg-input)", border: "1px solid var(--border-strong)", borderRadius: 8, padding: "7px 12px", fontSize: 11.5, fontWeight: 700, color: "#475569", cursor: "pointer" }}>
                        Cancel
                      </button>
                    </div>
                  ) : (
                    <>
                      ...
                      <span style={{ fontSize: 10.5, fontWeight: 700, color: "#475569", background: "var(--bg-input)", border: "1px solid var(--border-strong)", padding: "3px 9px", borderRadius: 99 }}>
                        AUTO (same host :5000) — editable
                      </span>
                      <button onClick={() => setEditingBackend(true)} style={{ display: "flex", alignItems: "center", gap: 5, background: "var(--bg-input)", border: "1px solid var(--border-strong)", borderRadius: 8, padding: "7px 12px", fontSize: 11.5, fontWeight: 700, color: "var(--text-secondary)", cursor: "pointer" }}>
                        <Code2 size={12} /> Edit
                      </button>
                    </>
                  )}
              ...
              <p style={{ margin: "14px 0 0 0", fontSize: 11.5, color: "#94a3b8", lineHeight: 1.6 }}>
                <Lightbulb size={12} style={{ display: "inline", verticalAlign: "middle" }} /> Next.js SDK routes (<code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>/api/…</code>) live on the same origin as this page.
                The Flask engine normally listens on port <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>5000</code> of the same host. Override the Flask URL above if your backend is deployed separately.
              </p>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  ...
                  <h4 style={{ margin: 0, fontSize: 14, fontWeight: 800, color: "var(--text-primary)" }}>Path A — Next.js SDK Routes (same origin)</h4>
                </div>
                <p style={{ margin: "0 0 10px 0", fontSize: 12, color: "#64748b", lineHeight: 1.6 }}>
                  Call <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5, color: "#6366f1" }}>{base.frontend}/api/…</code> directly from your app. Best for:
                </p>
              ...
              <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  ...
                  <h4 style={{ margin: 0, fontSize: 14, fontWeight: 800, color: "var(--text-primary)" }}>Path B — Python Flask Backend (API key)</h4>
                </div>
                <p style={{ margin: "0 0 10px 0", fontSize: 12, color: "#64748b", lineHeight: 1.6 }}>
                  Call <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5, color: "#6366f1" }}>{base.backend}/api/…</code> with your <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>x-api-key</code>. Best for:
                </p>
                <ul style={{ margin: 0, paddingLeft: 18, fontSize: 12, color: "#475569", lineHeight: 1.9 }}>
                  <li>Server-to-server integrations (attendance, ERP)</li>
                  <li>Partner HRMS log feed <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>/api/hrms/logs</code></li>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 }}>
                {[
                  ...
                  <button
                    ...
                    style={{ textAlign: "left", padding: 16, borderRadius: 12, border: "1px solid var(--border-strong)", background: "var(--bg-input)", cursor: "pointer", transition: "all 0.15s" }}
                  >
                    ...
                    <div style={{ fontSize: 12.5, fontWeight: 800, color: "var(--text-primary)", marginBottom: 3 }}>{s.title}</div>
        ...
        {activeTab === "presence" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16, boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
              <div>
                ...
                <h2 style={{ margin: "2px 0 0 0", fontSize: 18, fontWeight: 800, color: "var(--text-primary)" }}>
            ...
            {presenceLoading ? (
              <div style={{ padding: 40, textAlign: "center", color: "#64748b", background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-strong)" }}>
                Loading presence telemetry...
              </div>
            ) : filteredPresence.length === 0 ? (
              <div style={{ padding: 40, textAlign: "center", color: "#64748b", background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-strong)" }}>
                <Users size={36} color="#cbd5e1" style={{ marginBottom: 10 }} />
                <p style={{ margin: 0, fontSize: 14, fontWeight: 700, color: "var(--text-secondary)" }}>No active presence detected in the last {presenceMinutes} minutes</p>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 16 }}>
                {filteredPresence.map((p) => (
                  <div key={p.person_id} style={{ padding: 18, borderRadius: 18, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 4px 14px rgba(0,0,0,0.03)", display: "flex", gap: 14 }}>
                    <div style={{ width: 56, height: 56, borderRadius: 16, overflow: "hidden", background: "var(--bg-input)", flexShrink: 0, border: "2px solid var(--border-strong)" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6 }}>
                        <h4 style={{ margin: 0, fontSize: 14.5, fontWeight: 800, color: "var(--text-primary)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                          {p.person_name}
                        </h4>
        ...
        {activeTab === "history" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
              <div>
                ...
                <select
                  ...
                  style={{ padding: "8px 14px", borderRadius: 10, border: "1px solid var(--border-strong)", fontSize: 13, minWidth: 260, fontWeight: 600 }}
                >
              ...
              <div style={{ fontSize: 12, color: "#64748b" }}>
                Endpoint: <code style={{ background: "var(--bg-input)", padding: "2px 6px", borderRadius: 6, color: "#6366f1", fontFamily: "monospace" }}>GET /api/presence/history?person_id={historyPersonId || "ID"}</code>
              </div>
            </div>

            <div style={{ background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-strong)", overflowX: "auto" }}>
              <table style={{ width: "100%", minWidth: 640, borderCollapse: "collapse", textAlign: "left", fontSize: 13 }}>
                <thead>
                  <tr style={{ background: "var(--bg-input)", borderBottom: "1px solid var(--border-strong)", color: "#475569" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 16 }}>
              {cameraActivities.map((cam) => (
                <div key={cam.camera_id} style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <Cctv size={18} color="#0ea5e9" />
                      <h3 style={{ margin: 0, fontSize: 15, fontWeight: 800, color: "var(--text-primary)" }}>{cam.camera_name || cam.camera_id}</h3>
                    </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, padding: 12, borderRadius: 12, background: "var(--bg-input)", marginBottom: 12, textAlign: "center" }}>
                    <div>
                      <span style={{ fontSize: 10, fontWeight: 700, color: "#64748b" }}>Total Today</span>
                      <p style={{ margin: "2px 0 0 0", fontSize: 18, fontWeight: 900, color: "var(--text-primary)" }}>{cam.total_detections_today}</p>
                    </div>
                    <div>
        ...
        {activeTab === "unknown" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ padding: 16, borderRadius: 14, background: "var(--bg-card)", border: "1px solid var(--border-strong)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
              <div>
                <h3 style={{ margin: 0, fontSize: 15, fontWeight: 800, color: "var(--text-primary)" }}>Unknown / Unmatched CCTV Security Events Today</h3>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 14 }}>
              {unknownLogs.map((log) => (
                <div key={log.id} style={{ padding: 14, borderRadius: 14, background: "var(--bg-card)", border: "1px solid var(--border-strong)", display: "flex", gap: 12 }}>
                  <div style={{ width: 48, height: 48, borderRadius: 10, overflow: "hidden", background: "var(--bg-input)", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    {log.snapshot_url ? (
                      // eslint-disable-next-line @next/next/no-img-element
                  ...
                  <div>
                    <h4 style={{ margin: 0, fontSize: 13, fontWeight: 800, color: "var(--text-primary)" }}>Unknown Person</h4>
        ...
        {activeTab === "reference" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ padding: 20, borderRadius: 16, background: "linear-gradient(135deg, var(--bg-sidebar) 0%, var(--bg-card) 100%)", color: "#ffffff" }}>
              <h2 style={{ margin: "0 0 8px 0", fontSize: 18, fontWeight: 800, display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                ...
                <h3 style={{ margin: 0, fontSize: 15, fontWeight: 800, color: "var(--text-primary)" }}>Next.js SDK Routes</h3>
                <code style={{ marginLeft: 6, background: "var(--bg-input)", padding: "2px 8px", borderRadius: 6, fontSize: 11.5, fontFamily: "monospace", color: "#0ea5e9", fontWeight: 700 }}>{base.frontend || "/api/…"}</code>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                ...
                <h3 style={{ margin: 0, fontSize: 15, fontWeight: 800, color: "var(--text-primary)" }}>Python Flask Backend</h3>
                <code style={{ marginLeft: 6, background: "var(--bg-input)", padding: "2px 8px", borderRadius: 6, fontSize: 11.5, fontFamily: "monospace", color: "#6366f1", fontWeight: 700 }}>{base.backend || "http://…:5000"}</code>
            ...
            {[
              {
                ...
                body: (
                  <p style={{ margin: 0, fontSize: 12.5, color: "#475569", lineHeight: 1.7 }}>
                    Open the <strong>Partner Keys</strong> tab and generate a key named after your system (e.g. <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>HRMS Bridge</code>). Pick scopes:
...
SENTINEL_SDK="${base.frontend || "https://your-app.com"}"`,
              },
              {
                ...
                body: (
                  <p style={{ margin: 0, fontSize: 12.5, color: "#475569", lineHeight: 1.7 }}>
                    ...
                    The <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>/api/health</code> endpoint is public — no key needed.
                  </p>
                ),
  ...
  -H "x-api-key: ${activeKey}"`,
              },
              {
                ...
                body: (
                  <p style={{ margin: 0, fontSize: 12.5, color: "#475569", lineHeight: 1.7 }}>
                    Pull the list of people currently present. Use <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>/api/presence?minutes=10</code>
                    (same-origin SDK) or <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>/api/presence/all</code> (Flask, live engine).
                  </p>
                ),
              ...
              },
              {
                ...
                body: (
                  <p style={{ margin: 0, fontSize: 12.5, color: "#475569", lineHeight: 1.7 }}>
                    ...
                    Pass the person id you received from <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>/api/registered_faces</code>.
                  </p>
                ),
...
curl "${base.frontend || "https://your-app.com"}/api/presence/history?person_id=$PERSON_ID&limit=50" \\
  -H "x-api-key: ${activeKey}"`,
              },
              {
                ...
                body: (
                  <p style={{ margin: 0, fontSize: 12.5, color: "#475569", lineHeight: 1.7 }}>
                    Two options: enroll one face at a time with <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>POST /api/register</code>, or bulk-sync a batch of
                    employees with <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>POST /api/hrms/bulk_register</code> — attaching employee_code, department and designation so every
    ...
    "employees": [
      { "name": "Raja", "employee_code": "1111", "department": "Engineering", "designation": "Dev", "photo_base64": "<image>" }
              ...
              },
              {
                ...
                body: (
                  <p style={{ margin: 0, fontSize: 12.5, color: "#475569", lineHeight: 1.7 }}>
                    The Flask endpoint <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>GET /api/hrms/logs</code> (API key required) returns face-matching logs
                    enriched with employee_code, department, designation and camera info — ideal for attendance engines.
                    Filter by <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>since</code>, <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>employee_code</code>, and page with <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>limit</code>/<code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>offset</code>.
                  </p>
                ),
...
for log in r.json()["logs"]:
    print(log["person_name"], log.get("employee_code"), log["timestamp"], log.get("department"))`,
              },
              {
                ...
                body: (
                  <p style={{ margin: 0, fontSize: 12.5, color: "#475569", lineHeight: 1.7 }}>
                    Keys are SHA-256 hashed at rest and tracked with <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>last_used_at</code>. Keep them in environment variables, rotate by revoking the old key and creating a new one —
                    revocation takes effect immediately without restarting the backend. Use <code style={{ background: "var(--bg-input)", padding: "1px 5px", borderRadius: 5 }}>read</code>-only keys where possible.
                  </p>
                ),
...
curl -X POST "${base.frontend || "https://your-app.com"}/api/api_keys/<key_id>/revoke"`,
              ...
              <div key={step.n} style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6, flexWrap: "wrap" }}>
                      ...
                      <h3 style={{ margin: 0, fontSize: 15, fontWeight: 800, color: "var(--text-primary)" }}>{step.title}</h3>
                    </div>
                    {step.body}
                    <div style={{ marginTop: 12, borderRadius: 12, background: "var(--bg-sidebar)", overflow: "hidden" }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 12px", borderBottom: "1px solid var(--border)" }}>
                        <span style={{ fontSize: 10.5, fontWeight: 800, color: "#38bdf8", display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)" }}>
              <h4 style={{ margin: "0 0 10px 0", fontSize: 14, fontWeight: 800, color: "var(--text-primary)", display: "flex", alignItems: "center", gap: 8 }}>
                <ExternalLink size={15} color="#6366f1" /> Next Steps
              </h4>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                <button onClick={() => setActiveTab("reference")} style={{ display: "flex", alignItems: "center", gap: 6, padding: "9px 16px", borderRadius: 10, background: "var(--bg-input)", border: "1px solid var(--border-strong)", fontSize: 12.5, fontWeight: 700, color: "var(--text-secondary)", cursor: "pointer" }}>
                  <BookOpen size={14} /> Browse full API reference <ArrowRight size={13} />
                </button>
                <button onClick={() => setActiveTab("keys")} style={{ display: "flex", alignItems: "center", gap: 6, padding: "9px 16px", borderRadius: 10, background: "var(--bg-input)", border: "1px solid var(--border-strong)", fontSize: 12.5, fontWeight: 700, color: "var(--text-secondary)", cursor: "pointer" }}>
        ...
        {activeTab === "keys" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ padding: 24, borderRadius: 16, background: "linear-gradient(135deg, var(--bg-sidebar) 0%, var(--bg-card) 100%)", color: "#ffffff", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
              <div>
            ...
            <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, flexWrap: "wrap" }}>
                  <div>
                    ...
                    <input
                      ...
                      style={{ width: "100%", padding: "9px 12px", borderRadius: 10, border: "1px solid var(--border-strong)", fontSize: 13, fontWeight: 600, outline: "none" }}
                    />
                  </div>
                  <div>
                ...
                {keysError && (
                  <div style={{ padding: "10px 14px", borderRadius: 10, background: "#fef2f2", border: "1px solid var(--red-dim)", color: "#b91c1c", fontSize: 12.5, fontWeight: 700 }}>
                    {keysError}
                  </div>
                )}
            ...
            <div style={{ background: "var(--bg-card)", borderRadius: 16, border: "1px solid var(--border-strong)", overflowX: "auto" }}>
              <div style={{ padding: "14px 18px", borderBottom: "1px solid var(--border-strong)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <h4 style={{ margin: 0, fontSize: 14, fontWeight: 800, color: "var(--text-primary)" }}>Issued Keys</h4>
                <button onClick={fetchApiKeys} style={{ display: "flex", alignItems: "center", gap: 6, background: "var(--bg-input)", border: "1px solid var(--border-strong)", borderRadius: 8, padding: "6px 10px", fontSize: 11.5, fontWeight: 700, color: "#475569", cursor: "pointer" }}>
              ...
              {apiKeysLoading ? (
                ...
                <table style={{ width: "100%", minWidth: 860, borderCollapse: "collapse", textAlign: "left", fontSize: 13 }}>
                  <thead>
                    <tr style={{ background: "var(--bg-input)", borderBottom: "1px solid var(--border-strong)", color: "#475569" }}>
                  ...
                  <tbody>
                    {apiKeys.map((k) => (
                      <tr key={k.id} style={{ borderBottom: "1px solid #f1f5f9", opacity: k.revoked ? 0.5 : 1 }}>
                        ...
                        <td style={{ padding: "12px 16px" }}>
                          <code style={{ background: "var(--bg-input)", padding: "2px 8px", borderRadius: 6, fontSize: 11.5, color: "#6366f1", fontFamily: "monospace" }}>
                            {k.prefix}...
                          </code>
                        </td>
                        <td style={{ padding: "12px 16px" }}>
                        ...
                        <td style={{ padding: "12px 16px", textAlign: "right" }}>
                          {!k.revoked && (
                            <button
                              ...
                              style={{ display: "inline-flex", alignItems: "center", gap: 5, padding: "6px 10px", borderRadius: 8, background: "#fef2f2", border: "1px solid var(--red-dim)", color: "#b91c1c", fontSize: 11.5, fontWeight: 700, cursor: "pointer" }}
                              title="Revoke key"
                            >
...
print(data)`}
        ...
        {activeTab === "orgs" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", boxShadow: "0 2px 8px rgba(0,0,0,0.02)" }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <input
                  ...
                  style={{ flex: 1, minWidth: 280, padding: "9px 12px", borderRadius: 10, border: "1px solid var(--border-strong)", fontSize: 12.5, fontFamily: "monospace", fontWeight: 600, outline: "none" }}
                />
                <button
                  onClick={fetchOrgs}
            ...
            {orgError && (
              <div style={{ padding: "12px 16px", borderRadius: 10, background: "#fef2f2", border: "1px solid var(--red-dim)", color: "#b91c1c", fontSize: 12.5, fontWeight: 700 }}>
                {orgError}
              </div>
            )}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)" }}>
                <h4 style={{ margin: "0 0 12px 0", fontSize: 14, fontWeight: 800, color: "var(--text-primary)", display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  <input
                    ...
                    style={{ padding: "9px 12px", borderRadius: 10, border: "1px solid var(--border-strong)", fontSize: 13, fontWeight: 600, outline: "none" }}
                  />
                  <input
                    type="text"
                    ...
                    {orgs.map((o) => (
                      <button
                        ...
                        style={{
                          ...
                          padding: "12px 14px",
                          borderRadius: 10,
                          border: selectedOrg?.id === o.id ? "1px solid #6366f1" : "1px solid var(--border-strong)",
                      ...
                      >
                        <div>
                          <div style={{ fontSize: 13.5, fontWeight: 800, color: "var(--text-primary)" }}>{o.name}</div>
                          <div style={{ fontSize: 11.5, color: "#64748b" }}>
            ...
            {selectedOrg && (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ padding: 18, borderRadius: 14, background: "linear-gradient(135deg, #f5f3ff 0%, #eef2ff 100%)", border: "1px solid #c7d2fe", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
                  ...
                  {orgUsage && (
                    <div style={{ display: "flex", gap: 14 }}>
                      <div style={{ textAlign: "center", background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 10, padding: "6px 14px" }}>
                        <div style={{ fontSize: 17, fontWeight: 900, color: "var(--text-primary)" }}>{orgUsage.total_requests}</div>
                        <div style={{ fontSize: 10, fontWeight: 700, color: "#64748b", textTransform: "uppercase" }}>Requests</div>
                      </div>
                      <div style={{ textAlign: "center", background: "var(--bg-card)", border: "1px solid var(--red-dim)", borderRadius: 10, padding: "6px 14px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)" }}>
                    <h4 style={{ margin: "0 0 12px 0", fontSize: 14, fontWeight: 800, color: "var(--text-primary)" }}>Integration Apps</h4>
                    <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 }}>
                      {orgApps.length === 0 && <div style={{ fontSize: 12, color: "#94a3b8" }}>No apps yet.</div>}
                      {orgApps.map((a) => (
                        <div key={a.id} style={{ padding: "10px 12px", borderRadius: 10, background: "var(--bg-input)", border: "1px solid var(--border-strong)", fontSize: 12.5 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <input
                        ...
                        style={{ flex: 1, padding: "8px 10px", borderRadius: 8, border: "1px solid var(--border-strong)", fontSize: 12, outline: "none" }}
                      />
                      <select
                        value={appForm.app_type}
                        onChange={(e) => setAppForm({ ...appForm, app_type: e.target.value })}
                        style={{ padding: "8px 10px", borderRadius: 8, border: "1px solid var(--border-strong)", fontSize: 12, outline: "none" }}
                      >
                  ...
                  <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)" }}>
                    <h4 style={{ margin: "0 0 12px 0", fontSize: 14, fontWeight: 800, color: "var(--text-primary)" }}>App-Scoped API Keys</h4>
                    <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 }}>
                      {orgKeys.length === 0 && <div style={{ fontSize: 12, color: "#94a3b8" }}>No keys yet.</div>}
                      {orgKeys.map((k) => (
                        <div key={k.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", borderRadius: 10, background: "var(--bg-input)", border: "1px solid var(--border-strong)", fontSize: 12.5 }}>
                          <div>
                ...
                <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 }}>
                    ...
                    {orgWebhooks.map((w) => (
                      <div key={w.id} style={{ padding: "10px 12px", borderRadius: 10, background: "var(--bg-input)", border: "1px solid var(--border-strong)", fontSize: 12.5 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    ...
                    <input
                      ...
                      style={{ padding: "8px 10px", borderRadius: 8, border: "1px solid var(--border-strong)", fontSize: 12, outline: "none", fontFamily: "monospace" }}
                    />
                    <div style={{ display: "flex", gap: 8 }}>
                      <input
                        type="text"
                        ...
                        style={{ flex: 1, padding: "8px 10px", borderRadius: 8, border: "1px solid var(--border-strong)", fontSize: 12, outline: "none", fontFamily: "monospace" }}
                      />
                ...
                <div style={{ padding: 20, borderRadius: 16, background: "var(--bg-card)", border: "1px solid var(--border-strong)", overflowX: "auto" }}>
                  <h4 style={{ margin: "0 0 12px 0", fontSize: 14, fontWeight: 800, color: "var(--text-primary)", display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  {orgLogs.length === 0 ? (
                    ...
                    <table style={{ width: "100%", minWidth: 700, borderCollapse: "collapse", textAlign: "left", fontSize: 12.5 }}>
                      <thead>
                        <tr style={{ borderBottom: "1px solid var(--border-strong)", color: "#475569" }}>
                      ...
                      <tbody>
                        {orgLogs.map((l, i) => (
                          <tr key={i} style={{ borderBottom: "1px solid #f1f5f9" }}>
                            <td style={{ padding: "8px 10px", fontWeight: 700, color: "var(--text-primary)" }}>{l.person_name}</td>
...
function CodeSnippetCard({
  ...
  return (
    <div style={{ borderRadius: 16, background: "var(--bg-sidebar)", color: "#ffffff", padding: 20, border: "1px solid #1e293b" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
